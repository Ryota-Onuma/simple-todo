CREATE TABLE "public"."todos" ("id" serial NOT NULL, "title" text NOT NULL DEFAULT '無題', "content" text, "is_completed" boolean NOT NULL, "user_id" text NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), PRIMARY KEY ("id") , FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON UPDATE restrict ON DELETE restrict);
